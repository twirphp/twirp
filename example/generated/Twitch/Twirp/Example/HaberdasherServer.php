<?php
# Generated by the protocol buffer compiler (protoc-gen-twirp_php unknown-fields).  DO NOT EDIT!
...
final class HaberdasherServer implements RequestHandlerInterface
{
    ...
    private function handleMakeHatJson(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        ...
        try {
            ...
            $in->mergeFromJsonString((string)$req->getBody(), /* ignore_unknown */ true);
