...
/**
 * @internal {{ .Service | phpServiceName .File }}AbstractClient provides abstraction for JsonClient and Client (default).
...
{{- $inputType := $method.Input | phpMessageName $.File }}
     ...
     * {@inheritdoc}
     */
    public function {{ $method.Desc.Name }}(array $ctx, {{ $inputType }} $in): {{ $method.Output | phpMessageName $.File }}
    {
