...
/**
 * A JSON client that implements the {@see {{ .Service | phpServiceName .File }}} interface.
 ...
 */
final class {{ .Service | phpServiceName .File }}JsonClient implements {{ .Service | phpServiceName .File }}
{
    /**
     * @var server
     */
